...
CREATE INDEX IF NOT EXISTS idx_transactions_block_hash
    ...
    TABLESPACE pg_default;
-- Index: idx_transactions_received_time

-- DROP INDEX IF EXISTS blockchain.idx_transactions_received_time;

CREATE INDEX IF NOT EXISTS idx_transactions_received_time
    ON blockchain.transactions USING btree
    (received_time ASC NULLS LAST)
    TABLESPACE pg_default;
-- Index: transactions_block_hash_idx
